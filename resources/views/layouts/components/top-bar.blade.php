...
<div class="top-bar">
    ...
    <nav aria-label="breadcrumb" class="-intro-x mr-auto hidden sm:flex">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="#">Aplicaciones</a></li>
            @yield('breadcrumb')
    ...
    <div class="intro-x relative mr-3 sm:mr-6">
        ...
        <div class="search-result">
            <div class="search-result__content">
                <div class="search-result__content__title">Paginas</div>
                <div class="mb-5">
                    <a href="" class="flex items-center">
                        ...
                        <div class="ml-3">Configurar correo</div>
                    </a>
    ...
    <div class="intro-x dropdown w-8 h-8">
        ...
        <div class="dropdown-menu w-56">
            <ul class="dropdown-content bg-primary text-white">
                ...
                <li>
                    <a href="{{ url('/perfil') }}" class="dropdown-item hover:bg-white/5">
                ...
                <li>
                    <form method="POST" action="{{ route('logout') }}">
                        @csrf
                        <a href="javascript:void()" onclick="event.preventDefault(); this.closest('form').submit();" class="dropdown-item hover:bg-white/5">
